...
return new class extends Migration
{
    ...
    {
        Schema::create('area_a', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('category_id')->constrained('categorias')->onDelete('restrict');
            ...
            $table->index(['area_id', 'category_id', 'user_id']);
        });
    }
